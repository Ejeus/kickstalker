...
public class DetailFragmentBuilder {
	 ...
	 */
	public static void buildDetails(Context context, View view, 
			ImageView imageView, int tw, Project project){
		...
		prg.setProgressDrawable(
				context.getResources().getDrawable(project.getProgressDrawable()));
